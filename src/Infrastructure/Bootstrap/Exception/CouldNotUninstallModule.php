...
namespace Invertus\dpdBaltics\Infrastructure\Bootstrap\Exception;
...
final class CouldNotUninstallModule extends DpdException
{
    ...
    {
        return new self(
            sprintf('Failed to uninstall module tab (%s)', $moduleTab),
            ExceptionCode::INFRASTRUCTURE_FAILED_TO_UNINSTALL_MODULE_TAB,
            $exception,
            [
