...
class StepManualZones5 extends AbstractOnBoardStep
{
    ...
    public function takeStepData()
    {
        ...
        $templateDataObj->setParagraph(new OnBoardParagraph(
            $this->module->l('Feel free to add more countries or zip code ranges if you need.', self::FILE_NAME)
        ));
        $templateDataObj->setParagraph(new OnBoardParagraph(
            $this->module->l('Click save when you want to finish this Zone creation', self::FILE_NAME)
        ));
