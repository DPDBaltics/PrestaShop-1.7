...
class StepManualProducts3 extends AbstractOnBoardStep
{
    ...
    public function takeStepData()
    {
        ...
        $templateDataObj->setParagraph(new OnBoardParagraph(
            $this->module->l('As you can see most of the fields already pre-filed for you. However if you don\'t like default values, you can change them.', self::FILE_NAME)
        ));
        $templateDataObj->setParagraph(new OnBoardParagraph(
            $this->module->l('Name will be seen by your customer, you can change it to what makes most sense for him.', self::FILE_NAME)
        ));
