...
class StepManualProducts8 extends AbstractOnBoardStep
{
    ...
    public function takeStepData()
    {
        ...
        $templateDataObj->setParagraph(new OnBoardParagraph(
            $this->module->l('Feel free to configure more contracts if you need.', self::FILE_NAME)
        ));
        $templateDataObj->setParagraph(new OnBoardParagraph(
            $this->module->l('Click save when you want to finish this product configuration.', self::FILE_NAME)
        ));
