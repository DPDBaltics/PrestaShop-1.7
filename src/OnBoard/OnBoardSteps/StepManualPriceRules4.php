...
class StepManualPriceRules4 extends AbstractOnBoardStep
{
    ...
    public function takeStepData()
    {
        ...
        $templateDataObj->setParagraph(new OnBoardParagraph(
            $this->module->l('You can decide if you want rule apply to specific order price or order weight.', self::FILE_NAME)
        ));
        $templateDataObj->setParagraph(new OnBoardParagraph(
            $this->module->l('If you don\'t want to use this part, you should leave it empty.', self::FILE_NAME)
        ));
